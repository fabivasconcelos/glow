...
const TherapistProfile = () => {
    ...
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/therapists`).then((response) => {
    ...
    return (
        <div className="min-h-screen bg-[#453B2C] text-white py-6 font-inter relative">
            ...
            <div className="max-w-[900px] mx-auto px-6 md:px-12">
                ...
                <h1 className="text-[16px] font-inter font-bold text-[#DB8F00] mb-4">Select your therapist:</h1>
                ...
                <div className="relative mt-6">
                    ...
                    <div className="border-l-2 border-white pl-3">
                        <h2 className="text-[26px] font-gloock">{therapist.name}</h2>
                        <p className="text-white text-[14px] font-inter font-[500] mt-1">{therapist.specialization}</p>
                        <p className="text-[14px] mt-4 font-inter">{therapist.bio}</p>
                    </div>
                    ...
                    <div className="border-l-2 border-white pl-4 mt-4">
                ...
                <div className="mt-6 flex justify-center">
                    <button className="w-[60%] bg-[#DB8F00] h-[54px] text-white py-4 rounded-[18px] text-[16px] font-[700] font-inter"
